...
## v1.0.1419 (December 16th, 2019)

* _Join failure due to invalid URI fixed_ -Some users of Live Share were experiencing problems while trying to join a session, due to a parsing error. This release fixes that issue.

* _General improvement to Live Share service_
...
* _Improved auth workflow_, fixing multiple login issues, particularly #2914, #2926, #2961, #2982, #3003, #3004 ; in particular Mac OS Catalina users are no longer required to login through user codes
