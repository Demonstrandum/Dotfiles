...
class ProjectJSONContribution {
    ...
    collectDefaultCompletions(resource, result) {
        if (this.isProjectJSONFile(resource)) {
            ...
            result.add({ kind: 7 /* Class */, label: localize('json.project.default', 'Default project.json'), insertText: JSON.stringify(defaultValue, null, '\t'), documentation: '' });
        }
        return null;
    }
    makeJSONRequest(url) {
                ...
                return this.makeJSONRequest(queryUrl).then(resultObj => {
                    if (Array.isArray(resultObj.data)) {
                        ...
                        for (let i = 0; i < results.length; i++) {
                            ...
                            let item = { kind: 10 /* Property */, label: name, insertText: insertText, filterText: JSON.stringify(name) };
...
//# sourceMappingURL=projectJSONContribution.1.js.map